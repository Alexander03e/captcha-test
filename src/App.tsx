    ...
    return (
        <div>
            ...
            <div style={{display: "flex", gap: '16px'}}>
                <button style={captchaVariant === 1 ? activeStyle : {}} onClick={setCaptchaVariant.bind(null, 1)}>YandexCaptcha</button>
                <button style={captchaVariant === 2 ? activeStyle : {}} onClick={setCaptchaVariant.bind(null, 2)}>ReCAPTCHA</button>
            </div>
